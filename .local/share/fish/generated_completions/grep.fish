# grep
# Autogenerated from man page /nix/store/rx2wig5yhpbwhnqxdy4z7qivj9ln7fab-gnugrep-3.11/share/man/man1/grep.1.gz
...
complete -c grep -s P -l perl-regexp -d 'Interpret  PATTERNS as Perl-compatible regular expressions (PCREs)'
