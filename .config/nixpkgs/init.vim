...
let g:clipboard = {
      \   'name' : 'myClipboard',
      \   'copy' : {
      \     '+' : {lines, regtype -> extend(g:, {'my_internal_clipboard': [lines, regtype]})},
      \     '*' : {lines, regtype -> extend(g:, {'my_internal_clipboard': [lines, regtype]})},
      \   },
      \   'paste': {
      \     '+': {-> get(g:, 'my_internal_clipboard', [])},
      \     '*': {-> get(g:, 'my_internal_clipboard', [])},
      \   },
      \ }
...
" let g:ormolu_options=["--indentation", "2", "--record-brace-space", "True", "--newlines-between-decls", "2", "--no-cabal"]
